...
(defun memo-hide-thread (&optional all-indent)
  ...
  (let (p b e (whole 0) col)
	...
	(re-search-backward memo-entry-separated-tag nil t)
	(beginning-of-line 2)
;	(if (re-search-forward "^\\[[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9]\\( +[0-9][0-9]:[0-9][0-9]\\)?\\] *$" (save-excursion (end-of-line) (point)) t) ;edit
	...
	(narrow-to-region b e)
      ...
      (save-excursion
	(end-of-line)
;	(if (or (and (re-search-backward "^ *-->" nil t) ;edit
...
;	(setq date "____/__/__") ;edit
	(setq date "____-__-__")
;	(if (string-match "^\\[\\(..../../..\\( *..:..\\)?\\)] *$" head) ;edit
    ...
    (save-excursion
	  ...
	  (progn
		...
		(split-window-calculate-height "30")
	      ...
	      (goto-char b)
	      (save-restriction
;		(and (re-search-forward "^\\[[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9]\\]\\( \\[[0-9][0-9]:[0-9][0-9]\\]\\)* *" nil t) ;edit
